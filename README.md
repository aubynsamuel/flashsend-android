...
<div align="center" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 1px;">
    <img src="screenShots/authentication-portrait.webp" width="40%" alt="Authentication Screen">
    <img src="screenShots/home_screen-portrait.webp" width="40%" alt="Chats Screen">
    <img src="screenShots/messages_screen-portrait.webp" width="40%" alt="Chat Room">
    <img src="screenShots/message_actions-portrait.webp" width="40%" alt="Message Actions & Reactions">
    <img src="screenShots/profile_screen-portrait.webp" width="40%" alt="Profile Screen">
    <img src="screenShots/settings-portrait.webp" width="40%" alt="Settings Screen">
    <img src="screenShots/home_screen_dark-portrait.webp" width="40%" alt="Dark Mode">
    <img src="screenShots/notifications-portrait.webp" width="40%" alt="Notifications">
</div>
